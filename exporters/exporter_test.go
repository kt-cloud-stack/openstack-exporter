...
var fixtures map[string]string = map[string]string{
	...
	"/loadbalancer/v2.0/lbaas/listeners":                                                "loadbalancer_listeners",
	"/loadbalancer/v2.0/lbaas/listeners/023f2e34-7806-443b-bfae-16c324569a3d/stats":     "loadbalancer_listener_stats",
